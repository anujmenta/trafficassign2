...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(200, 400, kernel_size=5)
        self.batchnorm3 = nn.BatchNorm2d(400)
        self.conv4 = nn.Conv2d(400, 750, kernel_size=3)
        self.batchnorm4 = nn.BatchNorm2d(750)
        self.conv5 = nn.Conv2d(750, 1000, kernel_size=3)
        self.batchnorm5 = nn.BatchNorm2d(1000)
        self.dropout = nn.Dropout2d()
        self.fc1 = nn.Linear(1000*2*2, 500)
    ...
    def forward(self, x):
        ...
        x = self.dropout(x)
        x = self.batchnorm5(F.max_pool2d(F.leaky_relu(self.conv5(x)),2))
        x = self.dropout(x)
