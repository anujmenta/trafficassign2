...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(200, 500, kernel_size=3)
        self.batchnorm2 = nn.BatchNorm2d(500)
        self.conv3 = nn.Conv2d(500, 1000, kernel_size=3)
        self.batchnorm3 = nn.BatchNorm2d(1000)
